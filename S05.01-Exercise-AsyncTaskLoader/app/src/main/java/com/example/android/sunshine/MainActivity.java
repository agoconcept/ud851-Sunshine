...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int FORECAST_LOADER_ID = 12345;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putString(LOCATION_KEY, "Madrid");
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            Bundle bundle = new Bundle();
            bundle.putString(LOCATION_KEY, "Madrid");
            getSupportLoaderManager().restartLoader(FORECAST_LOADER_ID, bundle, this);
            return true;
        }
